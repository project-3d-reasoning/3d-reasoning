    ...
    if "qwen2.5" in model_args.model_name_or_path.lower():
        ...
        if not use_custom_model:
            ...
            for k in [
                ...
                "fusion_lambda_auto_balance",
                "fusion_lambda_target_align",
                "fusion_lambda_target_ortho",
                "fusion_lambda_target_recon",
                "fusion_lambda_auto_ema",
                "fusion_lambda_auto_min",
                "fusion_lambda_auto_max",
                "fusion_lambda_auto_eps",
                "tune_mm_vision",
                "tune_mm_vision_lora",
