...
model_path=/inspire/hdd/project/qproject-fundationmodel/public/yxliu/test/Demongorgan/3d-reasoning/output/7b-hsic-only
USE_HSIC_FUSION=true
BACKPROP_HSIC_LOSS=true
HSIC_LOSS_WEIGHT=10
...
model_args_str="pretrained=$model_path,use_flash_attention_2=true,max_num_frames=32,max_length=12800,min_pixels=$((16*28*28)),max_pixels=$((576*28*28)),use_hsic_fusion=$USE_HSIC_FUSION,backprop_hsic_loss=$BACKPROP_HSIC_LOSS,hsic_loss_weight=$HSIC_LOSS_WEIGHT,hsic_rbf_sigma_2d=$HSIC_RBF_SIGMA_2D,hsic_rbf_sigma_3d=$HSIC_RBF_SIGMA_3D,unique_3d_hsic_max_samples=$UNIQUE_3D_HSIC_MAX_SAMPLES"
